<template>
     <div class="w-full h-full relative flex flex-col items-center">
          ...
          <div class="w-4/5 sm:w-3/5 mt-24 sm:mt-48 relative">
               <h1 style="animation-duration: 0.5s" class="text-5xl sm:text-6xl font-bold text-color-101B61 animate__animated animate__fadeInRightBig">{{ dataProjects.title }} <span class="w-3 h-3 ml-[-7px] mb-[-1px] rounded-full bg-color-8002E0 inline-block"></span></h1>
